    ...
    <div class="space-y-6">
        <section class="rounded-2xl border border-zinc-200 bg-white p-5 dark:border-zinc-800 dark:bg-zinc-900">
            <div class="flex flex-wrap items-start justify-between gap-4">
                ...
                <button type="button"
                    ...
                    :disabled="syncing || loading" @click="syncEntitlements">
                    {{ syncing ? "Synchronisiere..." : "Status synchronisieren" }}
                </button>
            </div>

            <div class="mt-4 grid gap-3 md:grid-cols-[1fr_auto]">
                <input v-model="keyCode" type="text" placeholder="Lizenzkey eingeben (z. B. LIC-XXXX-XXXX)"
                ...
                <button type="button"
                    ...
                    :disabled="activating || loading" @click="activateKey">
            ...
            <div class="mt-4 grid gap-3 sm:grid-cols-2 xl:grid-cols-4">
                ...
                <div class="rounded-xl border border-zinc-200 bg-zinc-50 p-3 dark:border-zinc-700 dark:bg-zinc-950">
                    ...
                    <p class="mt-1 text-sm font-semibold"
                        :class="status?.has_tenant_token ? 'text-emerald-600 dark:text-emerald-400' : 'text-red-600 dark:text-red-400'">
        ...
        <section class="rounded-2xl border border-zinc-200 bg-white p-5 dark:border-zinc-800 dark:bg-zinc-900">
            ...
            <div v-else class="grid gap-3 md:grid-cols-2 xl:grid-cols-3">
                <div v-for="mod in status?.modules || []" :key="mod.module_key" class="rounded-xl border p-4" :class="mod.entitled
                    ...
                    <div class="flex items-start justify-between gap-2">
                        ...
                        <span class="rounded-md border px-2 py-1 text-xs font-semibold" :class="mod.entitled
            ...
            <div v-if="!loading && entitledModules.length === 0"
